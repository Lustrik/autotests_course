...
class TestStep13(unittest.TestCase):
    ...
    def testStep1(self):
        self.stepTemplate("http://suninjuly.github.io/registration1.html")
    def testStep2(self):
        self.stepTemplate("http://suninjuly.github.io/registration2.html")

    def stepTemplate(self, link):
        try:
            ...
            self.assertEqual("Congratulations! You have successfully registered!", welcome_text, "Some shit happened")
